    ...
    <div className="flex min-h-screen bg-slate-950 text-slate-50">
      <aside className="flex w-64 flex-col border-r border-slate-800 bg-slate-950/80">
        <div className="flex items-center gap-2 border-b border-slate-800 px-4 py-4">
          ...
          <div>
            <div className="text-sm font-semibold">Loan Management</div>
            <div className="text-xs text-slate-400">FSP Portal</div>
          </div>
        </div>
        <nav className="flex-1 space-y-2 px-3 py-4 text-sm">
          <div className="text-xs font-semibold uppercase tracking-wide text-slate-500 px-2">
            Overview
          </div>
          ...
          <div className="mt-4 text-xs font-semibold uppercase tracking-wide text-slate-500 px-2">
            Product Management
          </div>
