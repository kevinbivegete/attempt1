          ...
          <tbody>
            {queue.map((l) => (
              ...
              >
                ...
                <td className="px-4 py-2 text-slate-200">{l.customer}</td>
                <td className="px-4 py-2 text-slate-200">{l.product}</td>
                <td className="px-4 py-2 text-slate-200">{l.requested}</td>
                <td className="px-4 py-2 text-slate-300">{l.submittedAt}</td>
