      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-4 space-y-3">
            ...
            <button className="w-full rounded-md bg-slate-200 dark:bg-slate-800 px-3 py-2 text-xs font-semibold text-slate-900 dark:text-slate-100 hover:bg-slate-300 dark:hover:bg-slate-700">
              Run Eligibility Check
            </button>
            <div className="rounded-md border border-dashed border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950/60 p-2 text-[11px] text-slate-600 dark:text-slate-300">
