        ...
        <table className="min-w-full text-left text-xs">
          ...
          <tbody>
            {disbursements.map((d) => (
              ...
              >
                <td className="px-4 py-2 text-slate-100">{d.id}</td>
                <td className="px-4 py-2 text-slate-200">{d.loanId}</td>
                <td className="px-4 py-2 text-slate-200">{d.customer}</td>
                <td className="px-4 py-2 text-slate-200">{d.channel}</td>
                <td className="px-4 py-2 text-slate-200">{d.amount}</td>
                <td className="px-4 py-2">
                  <span className="inline-flex rounded-full bg-amber-500/15 px-2 py-0.5 text-[11px] font-medium text-amber-300">
                    {d.status}
                  </span>
                </td>
                <td className="px-4 py-2 text-slate-300">{d.createdAt}</td>
