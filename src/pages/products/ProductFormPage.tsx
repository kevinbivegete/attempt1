      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 space-y-3">
            ...
            <div className="grid gap-3 md:grid-cols-2 text-xs">
              ...
              <div>
                <label className="mb-1 block text-slate-300">Min Amount</label>
                <input
                  type="number"
                  className="w-full rounded-md border border-slate-800 bg-slate-950 px-2 py-1.5 text-xs text-slate-100"
                />
              ...
              <div>
                <label className="mb-1 block text-slate-300">Max Amount</label>
                <input
                  type="number"
                  className="w-full rounded-md border border-slate-800 bg-slate-950 px-2 py-1.5 text-xs text-slate-100"
                />
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4 space-y-2">
            ...
            <button className="mt-1 w-full rounded-md border border-dashed border-slate-700 px-2 py-1.5 text-xs text-slate-300 hover:border-primary-500 hover:text-primary-300">
              + Add Fee
            </button>
          </div>
